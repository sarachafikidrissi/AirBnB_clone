...
class TestCityInstantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test creating City no Args results in an instance of City."""
        self.assertEqual(City, type(City()))

    def test_new_instance_stored_in_objects(self):
        """Test that a newly created is stored in the objects dictionary."""
        self.assertIn(City(), models.storage.all().values())

    def test_id_is_public_str(self):
        """Test 'id' attribute of a City instance is a string."""
        self.assertEqual(str, type(City().id))

    def test_created_at_is_public_datetime(self):
        """Test 'created_at'of a City instance is of type datetime."""
        self.assertEqual(datetime, type(City().created_at))

    def test_updated_at_is_public_datetime(self):
        """Test 'updated_at' of a City instance is of type datetime."""
        self.assertEqual(datetime, type(City().updated_at))

    def test_state_id_is_public_class_attribute(self):
        """Test that 'state_id' is a public class attribute of the City"""
        city = City()
    ...
    def test_two_cities_different_created_at(self):
        """Test that two City have different 'created_at' timestamps."""
        city1 = City()
        sleep(0.05)
        city2 = City()
    ...
    def test_two_cities_different_updated_at(self):
        """Test that two City have different 'updated_at' timestamps."""
        city1 = City()
        sleep(0.05)
        city2 = City()
    ...
    def test_args_unused(self):
        ...
        to City does not set any instance attributes to None."""
        city = City(None)
