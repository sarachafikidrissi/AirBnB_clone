...
* Clone the repository. git clone https://github.com/sarachafikidrissi/AirBnB_clone.git
* Open the /AirBnB_clone directory and execute console.py

### Setup

* You need Python interpreter.
IMPORTANT: The project was created in Ubuntu 20.04

---

## Documentation 

<a href="https://docs.python.org/3.8/library/cmd.html">`cmd module`</a><br>
<a href="https://intranet.alxswe.com/concepts/66">`packages`</a><br>
<a href="https://docs.python.org/3.8/library/uuid.html">`uuid module`</a><br>
<a href="https://docs.python.org/3.8/library/datetime.html">`datetime`</a><br>
<a href="https://docs.python.org/3.8/library/unittest.html#module-unittest">`unittest module`</a><br>
<a href="https://yasoob.me/2013/08/04/args-and-kwargs-in-python-explained/">`args/kwargs`</a><br>
<a href="https://www.pythonsheets.com/notes/python-tests.html">`Python test cheatsheet`</a><br>
---
